...
void main(){
    ...
    criar_linha_posicao(&lista, 0);
    criar_linha_posicao(&lista, 1);
    remover_linha_posicao(&lista, 1);
    remover_linha_posicao(&lista, 1);
    remover_linha_final(&lista);

    criar_linha_comeco(&lista);
    criar_linha_comeco(&lista);
    inserir_caractere_comeco(&lista, 'a', 0);
    inserir_caractere_comeco(&lista, 'b', 0);
    inserir_caractere_comeco(&lista, 'c', 0);
    inserir_caractere_comeco(&lista, 'd', 0);
    inserir_caractere_final(&lista, 'm', 1);
    inserir_caractere_posicao(&lista, 'p', 1, 0);
    remover_caractere_comeco(&lista, 0);
    remover_caractere_final(&lista, 0);
    remover_caractere_posicao(&lista, 0, 0);
